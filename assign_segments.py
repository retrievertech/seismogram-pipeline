...
def generate_json(data):
    ...
    json_assign = {}
    for key in data:
        json_assign.update({int(meanlines["features"][key]["id"]): meanline_database[key]["segments"]})
...
segments = get_features(r'bleh/segments.json')
meanlines = get_features(r'bleh/meanlines.json')
segment_data = get_features(r'endpoints.json')
